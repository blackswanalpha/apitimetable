...
public class LecturerDAO {
    ...
    public int getNextPrimaryKey() throws SQLException {
	 ...
	 public List<LecturerBean> fetchAllLecturers() throws SQLException {
	        final String selectSQL = "SELECT lecturer_id,lecturer_name,lecturer_contact,lecturer_email,lecturer_staff_no,lecturer_image,lecturer_gender,lecturer_location,lecturer_active,lecturer_type_id	 FROM lecturer";
	    ...
	    public List<LecturerBean> createLecturer(final LecturerBean lecturerBean) throws SQLException {
	        final String selectSQL = "INSERT INTO lecturer(lecturer_id,lecturer_name,lecturer_email,lecturer_image,lecturer_gender,lecturer_location,lecturer_active,lecturer_login_id,lecturer_staff_no,lecturer_type_id) values(" + this.getNextPrimaryKey() + ", '" +  lecturerBean.getLecturerName() +  "', '" + lecturerBean.getLecturerEmail() +  "', '" + lecturerBean.getLecturerImage() +  "', '" + lecturerBean.getLecturerGender() +  "', '" + lecturerBean.getLecturerLocation() +  "', '" + lecturerBean.getLecturerActive() +  "', " + lecturerBean.getLecturerLoginId() +  ", " + lecturerBean.getLecturerStaffNo() +  ", " + lecturerBean.getLecturerTypeId() +   ");";
	    ...
	    public List<LecturerBean> deleteLecturer(final LecturerBean lecturerBean) throws SQLException {
	        final String sql = "DELETE FROM lecturer WHERE lecturer_id=" + lecturerBean.getLecturerId();
	        try {
	            this.conn = this.dataSource.getConnection();
	            (this.cst = this.conn.prepareStatement(sql)).execute();
	        }
