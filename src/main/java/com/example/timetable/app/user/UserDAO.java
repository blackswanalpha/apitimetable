	    ...
	    public int getNextPrimaryKey() throws SQLException {
		 ...
		 public List<UserBean> fetchAllUsers() throws SQLException {
		    ...
		    public List<UserBean> updateUser(final UserBean userBean) throws SQLException {
		        final String sql = "update user set user_full_name='" + userBean.getUserFullName() +"', user_department_id=" +userBean.getUserDepartmentId()+", user_email='"+userBean.getUserEmail() +"', user_mobile=" +userBean.getUserMobile()+", user_login_id=" +userBean.getUserLoginId() +", user_imageUrl='"+userBean.getUserimageUrl() + "' where user_id=" +userBean.getUserId();
